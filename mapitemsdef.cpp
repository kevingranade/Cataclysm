...
void game::init_mapitems()
{
 ...
 setvector(
   mapitems[mi_fridgesnacks],
	...
	itm_pizza, itm_pie, itm_beer, NULL);
 ...
 setvector(
   mapitems[mi_alcohol],
	itm_whiskey, itm_vodka, itm_rum, itm_tequila, itm_beer, NULL);
 ...
 setvector(
   mapitems[mi_mil_rifles],
	...
	itm_silencer, itm_clip,itm_spare_mag,  itm_m203, itm_UPS_off, NULL);
...
// TODO: Replace kevlar with the ceramic plate armor
 setvector(
   mapitems[mi_military],
	...
	itm_binoculars, itm_spare_mag, NULL);
 ...
 setvector(
   mapitems[mi_drugdealer],
	...
	itm_mininuke, itm_spare_mag, NULL);
